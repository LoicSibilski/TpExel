...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(sheet.checkMaxColorLig(tabCellule));
		sheet.writeSheetOneLig(tabCellule, 12);
		//sheet.writeSheetLig(tabCellule, 1);
		
//		for (Cellule cellule : tabCellule ) {
//			sheet.writeSheetCell(cellule.getCol(), cellule.getLig(), cellule.getContenue());
//	}
		//sheet.creerSheet();
		//sheet.destroysheet();
